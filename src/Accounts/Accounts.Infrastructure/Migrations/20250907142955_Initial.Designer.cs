...
namespace Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20250907142955_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounts.Domain.AdminProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "Accounts.Domain.AdminProfile.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Accounts.Domain.ParticipantAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "Accounts.Domain.ParticipantAccount.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Accounts.Domain.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Accounts.Domain.RefreshSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Accounts.Domain.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Accounts.Domain.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("Accounts.Domain.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Accounts.Domain.AdminProfile", b =>
                {
                    b.HasOne("Accounts.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("Accounts.Domain.AdminProfile", "UserId")
            ...
            modelBuilder.Entity("Accounts.Domain.ParticipantAccount", b =>
                {
                    b.HasOne("Accounts.Domain.User", "User")
                        ...
                        .HasForeignKey("Accounts.Domain.ParticipantAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Accounts.Domain.RolePermission", b =>
                {
                    b.HasOne("Accounts.Domain.Permission", "Permission")
                    ...
                    b.HasOne("Accounts.Domain.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Accounts.Domain.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Accounts.Domain.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
